...
- **Instructions.** 196 mnemonics in 1149 differentially tested forms, covering
  500 of the 525 rows of the P1 roster — the rows are K's grammar of encodable
  forms, and 149 of them are alias spellings of another row. 110 of those
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 35 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
