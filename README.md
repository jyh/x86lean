...
- **Instructions.** 121 mnemonics in 893 differentially tested forms, covering
  500 of the 525 rows of the P1 roster — the rows are K's grammar of encodable
  forms, and 149 of them are alias spellings of another row. Thirty-five of those
  ...
  plus the two whole-register byte shifts `pslldq`/`psrldq` —
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 11 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
...
```
893 vectors · 88 pre-states · 78584 cases · 0 unexplained · 0 oracle leaks
```
