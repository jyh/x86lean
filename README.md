...
- **Instructions.** 172 mnemonics in 1058 differentially tested forms, covering
  500 of the 525 rows of the P1 roster — the rows are K's grammar of encodable
  forms, and 149 of them are alias spellings of another row. 86 of those
  ...
  `maxsd`/`minps`/`maxps`, the exact widenings `cvtss2sd`/`cvtsi2sdl`, and the truncations `cvttsd2si`/`cvttss2si`); the P1 roster excludes
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 27 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
