...
- **Instructions.** 97 mnemonics in 825 differentially tested forms, covering
...
- **Validation.** Every form is run against ACL2 x86isa on 70950 generated cases
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 6 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
...
```
825 vectors · 86 pre-states · 70950 cases · 0 unexplained · 0 oracle leaks
```
