...
- **Instructions.** 99 mnemonics in 828 differentially tested forms, covering
...
- **Validation.** Every form is run against ACL2 x86isa on 71208 generated cases
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 7 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
...
```
828 vectors · 86 pre-states · 71208 cases · 0 unexplained · 0 oracle leaks
```
