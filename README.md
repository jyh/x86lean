...
- **Instructions.** 124 mnemonics in 907 differentially tested forms, covering
  ...
  `pshufd`/`pshuflw`/`pshufhw` at both operand shapes,
...
**P1 SEALED — 21 batches landed. P2 IN PROGRESS — 12 batches landed.** ⭐ **P1's AVAILABLE WORK IS ZERO**: every
