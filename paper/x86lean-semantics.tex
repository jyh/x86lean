...
\src{docs/CURSOR-LEAK-CHECK-2026-09-13.md, the cursor-plant line and the 84-vs-88 pre-state note (D250); docs/CLAIMS.tsv[cursor\_cases, cursor\_leaks]; X86/Serialize.lean
...
\src{docs/DECISIONS.md D52, measured on the reference model before the constructor existed; D52's ``five bits (six at .q)''}
