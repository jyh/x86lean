...
read.
\src{docs/CLAIMS.tsv[k\_mnemonics, liblisa\_groups]; docs/TACAS-G1-POSITIONING.md, the scale and proof-support rows and 1d; docs/DECISIONS.md D220}
...
\src{docs/CLAIMS.tsv[proof\_round\_1, proof\_round\_2, proof\_round\_3, proof\_round\_4]; docs/P2-PROOF-INTERFACE.md, the runP\_code point and round 4}
...
\src{docs/CLAIMS.tsv[x86isa\_opcodes]; docs/TACAS-G1-POSITIONING.md 1b, verbatim from arXiv 1705.01225}
...
\src{docs/CLAIMS.tsv[k\_mnemonics]; docs/TACAS-G1-POSITIONING.md, the scale and proof-support rows and 1d; 158 is gated by
...
\src{docs/LIBLISA-HARDWARE-CHECK-2026-09-12.md; docs/DECISIONS.md D221; the quoted ``118 000'' is libLISA's own spacing and is not cited to the manifest, whose prose check reads comma separators only}
