...
read.
\src{docs/CLAIMS.tsv[coverage\_mnemonics, k\_mnemonics, liblisa\_groups]; docs/TACAS-G1-POSITIONING.md, the scale and proof-support rows and 1d; docs/DECISIONS.md D220}
...
\src{docs/CLAIMS.tsv[coverage\_mnemonics, k\_mnemonics]; docs/TACAS-G1-POSITIONING.md, the scale and proof-support rows and 1d;
