...
listed in that row's shapes. Of 158 mnemonics, 132 are exact, 26 are frame, and 0 are absent. The tier names are this project's coinage.
...
Counted by instructions, among those whose form has been asked the reference model therefore refuses
more than it executes, although more of the forms asked execute (106) than refuse (88); the unasked share
is larger than the difference in instructions, so the comparison does not yet extend to the whole gap.
...
p2\_bucket\_pairs\_refuses]; this sentence said ``Among the forms it has been asked'' until 2026-09-15, true only by instruction, D250}
...
The published figures are 158 mnemonics in 1{,}012 differentially tested vectors, read from the table
...
72 of the 158 table rows take an xmm operand (D250); docs/COVERAGE.md:5 and README.md:56-57, checked against the derivation by scripts/claimed\_forms.py --check in CI;
