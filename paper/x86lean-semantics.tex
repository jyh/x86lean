...
machine''~\cite{liblisa}. We have read that work's abstract, not its models.
...
where the two disagree by the manual and by reading the other model's rules. That arbiter is fallible
...
and a comparison of x86lean against libLISA's models is the most direct second source this work lacks.
