...
\src{docs/P2-PROOF-INTERFACE.md, problem 3 section 1: countdown\_writes\_no\_memory,
scan\_writes\_no\_memory; the equal counts are a coincidence of line wrapping}
...
labels.
\src{docs/TACAS-PRICING.md 1, the P2 proof interface block; docs/P2-PROOF-INTERFACE.md}
