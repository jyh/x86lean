...
The `±0` branch is therefore carried by the 818-case kernel differential against
IEEE-754 (D140 §2), which does exercise it, and NOT by this table.  Two different
instruments, named separately, never pooled. -/
