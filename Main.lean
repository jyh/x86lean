...
+ undefined-column)"
  ...
  -- EITHER direction.  It was TWELVE LOW — and twelve low is exactly the error
...
MATCHES, so a mis-parse dies rather than counting. The literal was TWELVE LOW, \
...
answers the residue batch 18 could not close — 143 of the 525 rows are alias \
