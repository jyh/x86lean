...
# x86lean coverage\n\n\
P0 roster: 20 mnemonics in " ++ toString vectors.length ++ " differentially tested forms.\n\n\
...
correctly. The differential vectors close this for the 38 forms below by assembling each `asm` \
