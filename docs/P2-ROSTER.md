...
`docs/DEMAND-CENSUS.md` — **406,551 instructions the model does
...
Cumulative share is over the whole uncovered gap (406,551 instructions), so a row's cumulative column answers: *if P2 stopped here, what fraction of the assembly class would the model execute?*

| rank | mnemonic | occurrences | share | cumulative | of it, MMX | oracle | K operand shapes |
|---|---|---|---|---|---|---|---|
| 1 | `pmaddwd` | 21,239 | 5.22% | 5.2% | 2% | ⛔ **REFUSES** | `xm`, `xx` |
| 2 | `psubusw` | 17,214 | 4.23% | 9.5% | 0% | ⛔ **REFUSES** | `xm`, `xx` |
| 3 | `vmovdqa` | 16,813 | 4.14% | 13.6% | — | ✔ | `mx`, `my`, `xm`, `xx`, `ym`, `yy` |
| 4 | `vpaddw` | 11,682 | 2.87% | 16.5% | — | ✔ | `xxm`, `xxx`, `yym`, `yyy` |
| 5 | `movq` | 11,109 | 2.73% | 19.2% | ⛔ **100% — PHANTOM ROW** | ✔ | `mx`, `rx`, `xm`, `xr`, `xx` |
| 6 | `vpaddd` | 10,950 | 2.69% | 21.9% | — | ✔ | `xxm`, `xxx`, `yym`, `yyy` |
| 7 | `vmovaps` | 7,599 | 1.87% | 23.8% | — | ✔ | `mx`, `my`, `xm`, `xx`, `ym`, `yy` |
| 8 | `vpmaddwd` | 7,209 | 1.77% | 25.5% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 9 | `psadbw` | 6,411 | 1.58% | 27.1% | ⚠️ 14% | ⛔ **REFUSES** | `xm`, `xx` |
| 10 | `vpsrad` | 6,338 | 1.56% | 28.7% | — | ⛔ **REFUSES** | `xxi`, `xxm`, `xxx`, `yyi`, `yym`, `yyx` |
| 11 | `vpsubw` | 6,234 | 1.53% | 30.2% | — | ✔ | `xxm`, `xxx`, `yym`, `yyy` |
| 12 | `vmovdqu` | 6,160 | 1.52% | 31.7% | — | ✔ | `mx`, `my`, `xm`, `xx`, `ym`, `yy` |
| 13 | `mulss` | 5,698 | 1.40% | 33.1% | — | ✔ | `xm`, `xx` |
| 14 | `packssdw` | 5,613 | 1.38% | 34.5% | 3% | ⛔ **REFUSES** | `xm`, `xx` |
| 15 | `mulsd` | 5,482 | 1.35% | 35.9% | — | ✔ | `xm`, `xx` |
| 16 | `vpmulhrsw` | 5,010 | 1.23% | 37.1% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 17 | `addss` | 4,696 | 1.16% | 38.2% | — | ✔ | `xm`, `xx` |
| 18 | `vshufps` | 4,693 | 1.15% | 39.4% | — | ⛔ **REFUSES** | `xxmi`, `xxxi`, `yymi`, `yyyi` |
| 19 | `pmullw` | 4,539 | 1.12% | 40.5% | ⚠️ 21% | ⛔ **REFUSES** | `xm`, `xx` |
| 20 | `paddsw` | 4,473 | 1.10% | 41.6% | ⚠️ 18% | ⛔ **REFUSES** | `xm`, `xx` |
| 21 | `addsd` | 4,260 | 1.05% | 42.7% | — | ✔ | `xm`, `xx` |
| 22 | `paddw` | 4,166 | 1.02% | 43.7% | ⛔ **100% — PHANTOM ROW** | ✔ | `xm`, `xx` |
| 23 | `vpbroadcastd` | 3,941 | 0.97% | 44.7% | — | ⛔ **REFUSES** | `xm`, `xx`, `ym`, `yx` |
| 24 | `pmaxsw` | 3,776 | 0.93% | 45.6% | ⚠️ 24% | ⛔ **REFUSES** | `xm`, `xx` |
| 25 | `vpunpcklwd` | 3,630 | 0.89% | 46.5% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 26 | `vaddps` | 3,434 | 0.84% | 47.3% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 27 | `vmovq` | 3,430 | 0.84% | 48.2% | — | ⛔ **REFUSES** | `mx`, `rx`, `xm`, `xr`, `xx` |
| 28 | `movd` | 3,386 | 0.83% | 49.0% | ⛔ **100% — PHANTOM ROW** | ✔ | `mx`, `rx`, `xm`, `xr` |
| 29 | `vpunpckhwd` | 3,352 | 0.82% | 49.8% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 30 | `pmaddubsw` | 3,188 | 0.78% | 50.6% | 2% | ⛔ **REFUSES** | `xm`, `xx` |
| 31 | `psubusb` | 3,087 | 0.76% | 51.4% | ⚠️ 16% | ⛔ **REFUSES** | `xm`, `xx` |
| 32 | `vpmaddubsw` | 3,048 | 0.75% | 52.1% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 33 | `vpackssdw` | 3,026 | 0.74% | 52.9% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 34 | `vpshufb` | 2,984 | 0.73% | 53.6% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 35 | `cvtss2sd` | 2,949 | 0.73% | 54.3% | — | ✔ | `xm`, `xx` |
| 36 | `psubw` | 2,932 | 0.72% | 55.0% | ⛔ **100% — PHANTOM ROW** | ✔ | `xm`, `xx` |
| 37 | `vsubps` | 2,795 | 0.69% | 55.7% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 38 | `pmuludq` | 2,790 | 0.69% | 56.4% | — | ⛔ **REFUSES** | `xm`, `xx` |
| 39 | `vmulps` | 2,715 | 0.67% | 57.1% | — | ⛔ **REFUSES** | `xxm`, `xxx`, `yym`, `yyy` |
| 40 | `pmulhrsw` | 2,690 | 0.66% | 57.7% | 4% | ⛔ **REFUSES** | `xm`, `xx` |

- The joined set — **367 mnemonics K has semantics for AND the corpus executes** — accounts for **369,145 instructions (90.8% of the gap)**.
...
|---|---|---|---|
| 1 | `endbr64` | 16,488 | 4.06% |
| 2 | `vmovdqa32` | 6,230 | 1.53% |
...
### Supply without demand — 211 mnemonics

K has semantics for these and the corpus never executes one. Cheap to model; worth nothing to model first.

`addsubpd`, `andnpd`, `andnps`, `andpd`, `andps`, `blendpd`, `blendps`, `blendvpd`, `cmppd`, `cmpps`, `cmpsd`, `cmpss`, `cmpxchg16b`, `cvtpd2dq`, `cvtpi2pd`, `cvtpi2ps`, `cvtps2pd`, `dppd`, `dpps`, `haddpd`, `hsubpd`, `hsubps`, `insertps`, `maskmovdqu`, `maxpd`, `minpd`, `movapd`, `movaps`, `movdqa`, `movdqu`, `movhps`, `movmskpd`, `movntpd`, `movsd`, `movss`, `movupd`, `movups`, `orpd`, `orps`, `paddq`, `pclmulqdq`, `pcmpeqq`, `pcmpestri`, `pcmpestrm`, `pcmpgtq`, `pcmpistri`, `pcmpistrm`, `pextrb`, `pextrq`, `phsubd`, `phsubsw`, `phsubw`, `pmaxsb`, `pmaxud`, `pmaxuw`, `pminsb`, `pmovsxbd`, `pmovsxbq`, `pmovzxbd`, `pmovzxbq`
...
|---|---|---|---|
| the oracle EXECUTES | 141 | 156,600 | 38.5% |
| the oracle REFUSES | 82 | 217,162 | 53.4% |
| **probed so far** | 223 | **373,762** | **91.9%** |
...
|---|---|---|---|
| the oracle EXECUTES | 118 | 128,253 | 31.5% |
| the oracle REFUSES | 88 | 169,877 | 41.8% |
| **probed so far** | 206 | **298,130** | **73.3%** |
| not asked at its own bucket | | 108,259 | 26.6% |

⇒ **the by-mnemonic table is ahead of the by-bucket one by
75,632 instructions, 18.6% of the gap** — that is
...
rank 1 in the demand list, 5.22% of the whole gap, refusing in the same run in
...
|---|---|---|---|---|
| 1 | SSE-legacy (xmm) | 140,389 | 34.53% | 34.5% |
| 2 | AVX2/AVX (ymm) | 108,554 | 26.70% | 61.2% |
| 3 | VEX-128 (v… xmm) | 62,252 | 15.31% | 76.5% |
| 4 | MMX (mm) | 42,881 | 10.55% | 87.1% |
| 5 | AVX-512 (zmm/k) | 33,884 | 8.33% | 95.4% |
| 6 | CET-IBT | 16,488 | 4.06% | 99.5% |
