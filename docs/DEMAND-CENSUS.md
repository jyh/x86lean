...
<!-- census-model: mnemonics=174 sha=78b9da3640892df1 rules=8f90175b2674001c -->
...
The model covers **174 mnemonics**. Every number below is a STATIC count of instruction occurrences in a disassembly, not a dynamic profile: it measures what a binary CONTAINS, which is the right question for deciding what to model next and the wrong one for deciding what is hot.
...
- **Covered by the model: 5,377,907 (100.0%).**
...
- Not mapped at all, and therefore counted as NOT covered: 1,934 (0.0%).
...
| 6 | `cvtsi2ssq` | 33 | 0.00% |
| 7 | `incsspq` | 28 | 0.00% |
| 8 | `xaddl (lock operand)` | 28 | 0.00% |
| 9 | `cmpxchgq (lock operand)` | 24 | 0.00% |
| 10 | `addl (lock operand)` | 22 | 0.00% |
| 11 | `divss` | 17 | 0.00% |
| 12 | `rdsspq` | 12 | 0.00% |
| 13 | `cvtsi2ssl` | 11 | 0.00% |
| 14 | `subsd` | 10 | 0.00% |
| 15 | `addss` | 10 | 0.00% |
| 16 | `rdseedl` | 8 | 0.00% |
| 17 | `pmuludq` | 8 | 0.00% |
| 18 | `pcmpestri` | 6 | 0.00% |
| 19 | `cmpxchgl (lock operand)` | 6 | 0.00% |
| 20 | `pause` | 4 | 0.00% |
| 21 | `pextrw` | 4 | 0.00% |
| 22 | `pinsrw` | 3 | 0.00% |
| 23 | `hlt` | 2 | 0.00% |
| 24 | `rdrandl` | 2 | 0.00% |
| 25 | `subl (lock operand)` | 2 | 0.00% |
...
| SSE-legacy (xmm) | 336 | 0.01% | `cvtsi2sdq`, `addsd`, `divsd`, `cvtsi2ssq`, `divss`, `cvtsi2ssl` |
...
- **Covered by the model: 864,686 (98.3%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 14,865 (1.7%).
...
| `CC` | both routes say compiler-emitted | 863,382 | 98.16% | 98.3% |
...
| SSE-legacy (xmm) | 848 | 0.10% | `cvtsi2ssq`, `addss`, `cvtsi2sdq`, `subss`, `addsd`, `divss` |
...
- **Covered by the model: 551,443 (91.4%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 51,439 (8.5%).
...
| 1 | `addsd` | 3,079 | 0.51% |
| 2 | `fldt` | 2,392 | 0.40% |
| 3 | `vmovups` | 2,321 | 0.38% |
| 4 | `fstp` | 2,291 | 0.38% |
| 5 | `subsd` | 1,868 | 0.31% |
| 6 | `fxch` | 1,516 | 0.25% |
| 7 | `vmovdqu` | 1,338 | 0.22% |
| 8 | `vmovsd` | 1,336 | 0.22% |
| 9 | `fstpt` | 1,142 | 0.19% |
| 10 | `vmulsd` | 1,141 | 0.19% |
| 11 | `vpcmpeqb` | 1,114 | 0.18% |
| 12 | `vpmovmskb` | 1,030 | 0.17% |
| 13 | `vaddsd` | 1,011 | 0.17% |
| 14 | `fld` | 879 | 0.15% |
| 15 | `vmovdqu64` | 821 | 0.14% |
| 16 | `vsubsd` | 819 | 0.14% |
| 17 | `vmovaps` | 699 | 0.12% |
| 18 | `vzeroupper` | 662 | 0.11% |
| 19 | `vpcmpeqd` | 630 | 0.10% |
| 20 | `kmovd` | 606 | 0.10% |
| 21 | `fmul` | 599 | 0.10% |
| 22 | `vmovdqa` | 593 | 0.10% |
| 23 | `vfmadd213pd` | 554 | 0.09% |
| 24 | `syscall` | 544 | 0.09% |
| 25 | `vmovq` | 490 | 0.08% |
...
| `AC` | ISA-suffixed name, but the body is not packed SIMD | 55,619 | 9.22% | 70.6% |
| `CC` | both routes say compiler-emitted | 504,808 | 83.64% | 95.1% |
...
| SSE-legacy (xmm) | 9,007 | 1.49% | `addsd`, `subsd`, `mulpd`, `addpd`, `addss`, `mulps` |
...
- **Covered by the model: 2,971,538 (95.3%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 128,690 (4.1%).
...
| 6 | `addss` | 4,384 | 0.14% |
| 7 | `vshufps` | 4,340 | 0.14% |
| 8 | `vpaddd` | 4,275 | 0.14% |
| 9 | `vpmaddwd` | 4,034 | 0.13% |
| 10 | `vpaddw` | 3,966 | 0.13% |
| 11 | `addsd` | 3,468 | 0.11% |
| 12 | `vaddps` | 3,418 | 0.11% |
| 13 | `vpsrad` | 2,949 | 0.09% |
| 14 | `vsubps` | 2,791 | 0.09% |
| 15 | `vmulps` | 2,620 | 0.08% |
| 16 | `packssdw` | 2,595 | 0.08% |
| 17 | `vpsubw` | 2,456 | 0.08% |
| 18 | `paddw (vector operand)` | 2,303 | 0.07% |
| 19 | `vmovdqu` | 2,176 | 0.07% |
| 20 | `subss` | 2,132 | 0.07% |
| 21 | `psubusb` | 1,762 | 0.06% |
| 22 | `movd (vector operand)` | 1,757 | 0.06% |
| 23 | `vpunpcklwd` | 1,633 | 0.05% |
| 24 | `vpunpckhwd` | 1,563 | 0.05% |
| 25 | `vpackssdw` | 1,439 | 0.05% |
...
| `CC` | both routes say compiler-emitted | 2,746,475 | 88.11% | 99.1% |
...
| SSE-legacy (xmm) | 34,850 | 1.12% | `pmaddwd`, `addss`, `addsd`, `packssdw`, `subss`, `psubusb` |
...
- **Covered by the model: 150,325 (99.1%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 1,351 (0.9%).
...
| 10 | `cmpnlepd` | 15 | 0.01% |
| 11 | `addsd` | 13 | 0.01% |
| 12 | `cvttps2dq` | 12 | 0.01% |
| 13 | `subsd` | 11 | 0.01% |
| 14 | `cvtdq2ps` | 10 | 0.01% |
| 15 | `mulps` | 10 | 0.01% |
| 16 | `divps` | 10 | 0.01% |
| 17 | `subl (lock operand)` | 6 | 0.00% |
| 18 | `addl (lock operand)` | 6 | 0.00% |
| 19 | `cvtdq2pd` | 5 | 0.00% |
| 20 | `mulpd` | 5 | 0.00% |
| 21 | `cvttpd2dq` | 4 | 0.00% |
| 22 | `divss` | 3 | 0.00% |
...
| `CC` | both routes say compiler-emitted | 150,388 | 99.14% | 99.1% |
...
| SSE-legacy (xmm) | 538 | 0.35% | `cvtsi2ssl`, `addss`, `pmuludq`, `cvtsd2ss`, `cvtsi2ssq`, `cvtsi2sdq` |
...
- **Covered by the model: 653,941 (90.5%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 68,042 (9.4%).
...
| `CC` | both routes say compiler-emitted | 412,101 | 57.05% | 98.9% |
...
| bucket | occurrences | share of column | the mnemonics in it |
|---|---|---|---|
| SSE-legacy (xmm) | 51,076 | 7.07% | `psubusw`, `pmaddwd`, `psadbw`, `pmullw`, `pmuludq`, `packssdw` |
...
- **Covered by the model: 332,592 (88.1%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 32,385 (8.6%).
...
| `CC` | both routes say compiler-emitted | 269,143 | 71.33% | 98.8% |
...
| SSE-legacy (xmm) | 8,387 | 2.22% | `psadbw`, `pmaxsw`, `pabsw`, `pmaddwd`, `pmuludq`, `pmaddubsw` |
...
- **4,784,269 instructions**, covered by the model **4,402,293 (92.0%)**.
...
- **Not covered: 381,976 instructions (8.0% of the class)** — this is the P2 demand, and the table below is it, per extension.

| bucket | occurrences | share of the class | share of the UNCOVERED work |
|---|---|---|---|
| SSE-legacy (xmm) | 115,848 | 2.42% | 30.3% |
| AVX2/AVX (ymm) | 108,554 | 2.27% | 28.4% |
| VEX-128 (v… xmm) | 62,252 | 1.30% | 16.3% |
| MMX (mm) | 43,045 | 0.90% | 11.3% |
| AVX-512 (zmm/k) | 33,884 | 0.71% | 8.9% |
| CET-IBT | 16,488 | 0.34% | 4.3% |
