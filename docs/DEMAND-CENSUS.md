...
<!-- census-model: mnemonics=168 sha=d4bb32a5d40890fa rules=39b5fd89d413b61a -->
...
| SSE-legacy (xmm) | 513 | 0.01% | `cvtsi2sd`, `mulsd`, `addsd`, `divsd`, `cvtsi2ss`, `cvtss2sd` |
...
| SSE-legacy (xmm) | 1,300 | 0.15% | `cvtsi2ss`, `cvttss2si`, `mulss`, `addss`, `cvtsi2sd`, `subss` |
