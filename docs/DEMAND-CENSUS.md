...
<!-- census-model: mnemonics=170 sha=72eeeeee80119f56 rules=4f406a4ad6cfa0b4 -->
...
The model covers **170 mnemonics**. Every number below is a STATIC count of instruction occurrences in a disassembly, not a dynamic profile: it measures what a binary CONTAINS, which is the right question for deciding what to model next and the wrong one for deciding what is hot.
...
- **Covered by the model: 5,377,801 (100.0%).**
...
- Not mapped at all, and therefore counted as NOT covered: 2,040 (0.0%).
...
| 7 | `cvtsi2ssq` | 33 | 0.00% |
| 8 | `incsspq` | 28 | 0.00% |
| 9 | `xaddl (lock operand)` | 28 | 0.00% |
| 10 | `cmpxchgq (lock operand)` | 24 | 0.00% |
| 11 | `addl (lock operand)` | 22 | 0.00% |
| 12 | `cvttsd2si` | 18 | 0.00% |
| 13 | `divss` | 17 | 0.00% |
| 14 | `rdsspq` | 12 | 0.00% |
| 15 | `cvtsi2ssl` | 11 | 0.00% |
| 16 | `subsd` | 10 | 0.00% |
| 17 | `addss` | 10 | 0.00% |
| 18 | `rdseedl` | 8 | 0.00% |
| 19 | `mulss` | 8 | 0.00% |
| 20 | `pmuludq` | 8 | 0.00% |
| 21 | `pcmpestri` | 6 | 0.00% |
| 22 | `cmpxchgl (lock operand)` | 6 | 0.00% |
| 23 | `pause` | 4 | 0.00% |
| 24 | `pextrw` | 4 | 0.00% |
| 25 | `pinsrw` | 3 | 0.00% |
...
| SSE-legacy (xmm) | 442 | 0.01% | `cvtsi2sdq`, `mulsd`, `addsd`, `divsd`, `cvtsi2ssq`, `cvttsd2si` |
...
- **Covered by the model: 864,236 (98.3%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 15,315 (1.7%).
...
| 3 | `fstp` | 255 | 0.03% |
| 4 | `fxch` | 196 | 0.02% |
| 5 | `cvttss2si` | 176 | 0.02% |
| 6 | `mulss` | 176 | 0.02% |
| 7 | `fldcw` | 170 | 0.02% |
| 8 | `addss` | 154 | 0.02% |
| 9 | `cvtsi2sdq` | 153 | 0.02% |
| 10 | `fldt` | 140 | 0.02% |
| 11 | `fstpt` | 134 | 0.02% |
| 12 | `fildll` | 131 | 0.01% |
| 13 | `hlt` | 105 | 0.01% |
...
| SSE-legacy (xmm) | 1,298 | 0.15% | `cvtsi2ssq`, `cvttss2si`, `mulss`, `addss`, `cvtsi2sdq`, `subss` |
...
- **Covered by the model: 547,491 (90.7%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 55,391 (9.2%).
...
| 2 | `addsd` | 3,079 | 0.51% |
| 3 | `fldt` | 2,392 | 0.40% |
| 4 | `vmovups` | 2,321 | 0.38% |
| 5 | `fstp` | 2,291 | 0.38% |
| 6 | `subsd` | 1,868 | 0.31% |
| 7 | `fxch` | 1,516 | 0.25% |
| 8 | `vmovdqu` | 1,338 | 0.22% |
| 9 | `vmovsd` | 1,336 | 0.22% |
| 10 | `fstpt` | 1,142 | 0.19% |
| 11 | `vmulsd` | 1,141 | 0.19% |
| 12 | `vpcmpeqb` | 1,114 | 0.18% |
| 13 | `vpmovmskb` | 1,030 | 0.17% |
| 14 | `vaddsd` | 1,011 | 0.17% |
| 15 | `fld` | 879 | 0.15% |
| 16 | `vmovdqu64` | 821 | 0.14% |
| 17 | `vsubsd` | 819 | 0.14% |
| 18 | `vmovaps` | 699 | 0.12% |
| 19 | `vzeroupper` | 662 | 0.11% |
| 20 | `vpcmpeqd` | 630 | 0.10% |
| 21 | `kmovd` | 606 | 0.10% |
| 22 | `fmul` | 599 | 0.10% |
| 23 | `vmovdqa` | 593 | 0.10% |
| 24 | `vfmadd213pd` | 554 | 0.09% |
| 25 | `syscall` | 544 | 0.09% |
...
| `AC` | ISA-suffixed name, but the body is not packed SIMD | 55,619 | 9.22% | 68.4% |
| `CC` | both routes say compiler-emitted | 504,808 | 83.64% | 94.6% |
...
| SSE-legacy (xmm) | 12,959 | 2.15% | `mulsd`, `addsd`, `subsd`, `mulss`, `mulpd`, `addpd` |
...
- **Covered by the model: 2,961,679 (95.0%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 138,549 (4.4%).
...
| 18 | `packssdw` | 2,595 | 0.08% |
| 19 | `vpsubw` | 2,456 | 0.08% |
| 20 | `paddw (vector operand)` | 2,303 | 0.07% |
| 21 | `vmovdqu` | 2,176 | 0.07% |
| 22 | `subss` | 2,132 | 0.07% |
| 23 | `psubusb` | 1,762 | 0.06% |
| 24 | `movd (vector operand)` | 1,757 | 0.06% |
| 25 | `vpunpcklwd` | 1,633 | 0.05% |
...
| `CC` | both routes say compiler-emitted | 2,746,475 | 88.11% | 98.8% |
...
| SSE-legacy (xmm) | 44,709 | 1.43% | `pmaddwd`, `mulss`, `addss`, `mulsd`, `addsd`, `packssdw` |
...
- **Covered by the model: 150,081 (98.9%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 1,595 (1.1%).
...
| 8 | `cvtsd2ss` | 46 | 0.03% |
| 9 | `cvtsi2ssq` | 44 | 0.03% |
| 10 | `cvtsi2sdq` | 28 | 0.02% |
| 11 | `divsd` | 25 | 0.02% |
| 12 | `cvttsd2si` | 22 | 0.01% |
| 13 | `cmpnleps` | 16 | 0.01% |
| 14 | `cmpnlepd` | 15 | 0.01% |
| 15 | `addsd` | 13 | 0.01% |
| 16 | `cvttps2dq` | 12 | 0.01% |
| 17 | `subsd` | 11 | 0.01% |
| 18 | `cvtdq2ps` | 10 | 0.01% |
| 19 | `mulps` | 10 | 0.01% |
| 20 | `divps` | 10 | 0.01% |
| 21 | `subl (lock operand)` | 6 | 0.00% |
| 22 | `addl (lock operand)` | 6 | 0.00% |
| 23 | `cvtdq2pd` | 5 | 0.00% |
| 24 | `mulpd` | 5 | 0.00% |
| 25 | `cvttpd2dq` | 4 | 0.00% |
...
| `CC` | both routes say compiler-emitted | 150,388 | 99.14% | 98.9% |
...
| SSE-legacy (xmm) | 782 | 0.52% | `cvtsi2ssl`, `addss`, `cvttss2si`, `mulss`, `pmuludq`, `mulsd` |
...
- **Covered by the model: 653,034 (90.4%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 68,949 (9.5%).
...
| 18 | `mulsd` | 604 | 0.08% |
| 19 | `pmaxsw` | 574 | 0.08% |
| 20 | `vpmaddwd` | 538 | 0.07% |
| 21 | `addsd` | 495 | 0.07% |
| 22 | `psubusb` | 477 | 0.07% |
| 23 | `divsd` | 466 | 0.06% |
| 24 | `pmaddubsw` | 463 | 0.06% |
| 25 | `pavgw` | 444 | 0.06% |
...
| `CA` | packed-SIMD body, but no ISA suffix in the name | 81,330 | 11.26% | 89.0% |
| `AC` | ISA-suffixed name, but the body is not packed SIMD | 31,862 | 4.41% | 89.4% |
| `CC` | both routes say compiler-emitted | 412,101 | 57.05% | 98.7% |
...
| bucket | occurrences | share of column | the mnemonics in it |
|---|---|---|---|
| SSE-legacy (xmm) | 51,983 | 7.20% | `psubusw`, `pmaddwd`, `psadbw`, `pmullw`, `pmuludq`, `packssdw` |
...
- **Covered by the model: 331,492 (87.9%).**
- Mapped to a roster name the model does not have: 0 (0.0%).
...
- Not mapped at all, and therefore counted as NOT covered: 33,485 (8.9%).
...
| 20 | `vpsadbw` | 504 | 0.13% |
| 21 | `pshufw` | 437 | 0.12% |
| 22 | `vpunpckhqdq` | 421 | 0.11% |
| 23 | `vpmaddubsw` | 414 | 0.11% |
| 24 | `punpcklwd (vector operand)` | 384 | 0.10% |
| 25 | `punpcklbw (vector operand)` | 378 | 0.10% |
...
| `CC` | both routes say compiler-emitted | 269,143 | 71.33% | 98.4% |
...
| SSE-legacy (xmm) | 9,487 | 2.51% | `psadbw`, `pmaxsw`, `pabsw`, `mulsd`, `pmaddwd`, `pmuludq` |
...
- **4,784,269 instructions**, covered by the model **4,390,183 (91.8%)**.
...
- **Not covered: 394,086 instructions (8.2% of the class)** — this is the P2 demand, and the table below is it, per extension.

| bucket | occurrences | share of the class | share of the UNCOVERED work |
|---|---|---|---|
| SSE-legacy (xmm) | 127,958 | 2.67% | 32.5% |
| AVX2/AVX (ymm) | 108,554 | 2.27% | 27.5% |
| VEX-128 (v… xmm) | 62,252 | 1.30% | 15.8% |
| MMX (mm) | 43,045 | 0.90% | 10.9% |
| AVX-512 (zmm/k) | 33,884 | 0.71% | 8.6% |
| CET-IBT | 16,488 | 0.34% | 4.2% |
