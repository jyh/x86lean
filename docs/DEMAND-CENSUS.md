...
<!-- census-model: mnemonics=170 sha=72eeeeee80119f56 rules=8b755c5c27d9af53 -->
...
| bucket | occurrences | share of column | the mnemonics in it |
|---|---|---|---|
| SSE-legacy (xmm) | 12,955 | 2.15% | `mulsd`, `addsd`, `subsd`, `mulss`, `mulpd`, `addpd` |
...
| SSE-legacy (xmm) | 44,696 | 1.43% | `pmaddwd`, `mulss`, `addss`, `mulsd`, `addsd`, `packssdw` |
...
| SSE-legacy (xmm) | 774 | 0.51% | `cvtsi2ssl`, `addss`, `cvttss2si`, `mulss`, `pmuludq`, `mulsd` |
...
| bucket | occurrences | share of column | the mnemonics in it |
|---|---|---|---|
| SSE-legacy (xmm) | 51,970 | 7.19% | `psubusw`, `pmaddwd`, `psadbw`, `pmullw`, `pmuludq`, `packssdw` |
