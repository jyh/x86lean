...
rows read identically on those two and on an Intel Xeon Platinum 8370C (D272). With B4's rows added, 488 read
identically on the EPYC and the i7-8700B (D274). That is plan v1 §4.4's
